import{r,j as e,s as i}from"./main-0a219b4f.js";const d="_text_uwn3w_1",h={text:d,"roll-up":"_roll-up_uwn3w_1"},P=({sentences:t})=>{const[s,a]=r.useState(t[0]);return r.useEffect(()=>{let o=0;const l=setInterval(()=>{o=(o+1)%t.length,a(t[o])},1500);return()=>clearInterval(l)},[t]),e.jsx("div",{className:h.text,children:s},s)},u=i.a`
    display: flex;
    flex-grow: 1;
    align-items: center;
    padding: 12px;
