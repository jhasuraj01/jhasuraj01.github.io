import{r as n,i as h,o as y,a as b,s as r,L as f,j as e,u as k,b as L}from"./main-946ee509.js";import{R as v,P as S,p as E}from"./projects-4431a71e.js";import{S as M}from"./SocialConnect-723f540b.js";import{v as d}from"./variables-dc3f4fb5.js";var P=function(t){n.useEffect(t,[])};const I=P;var Z=function(t){var o=n.useRef(t);o.current=t,I(function(){return function(){return o.current()}})};const z=Z;var A=function(t){var o=n.useRef(0),s=n.useState(t),l=s[0],a=s[1],i=n.useCallback(function(C){cancelAnimationFrame(o.current),o.current=requestAnimationFrame(function(){a(C)})},[]);return z(function(){cancelAnimationFrame(o.current)}),[l,i]};const _=A;var R=function(t,o){t===void 0&&(t=1/0),o===void 0&&(o=1/0);var s=_({width:h?window.innerWidth:t,height:h?window.innerHeight:o}),l=s[0],a=s[1];return n.useEffect(function(){if(h){var i=function(){a({width:window.innerWidth,height:window.innerHeight})};return y(window,"resize",i),function(){b(window,"resize",i)}}},[]),l};const j=R,T=[{duration:"Aug 2023 - Present",company:"Cypherock",role:"Full Stack Developer Intern",description:"Working with Cypherock X1 hardware wallet & adding new features in cySync Desktop App. Developed AI-powered automation tools for Lead Generation with 85% success rate.",location:"Singapore • Remote",skills:"TypeScript, React.js, Node.js, Blockchain",type:"Internship"},{duration:"Jun 2023 - Aug 2023",company:"Barclays",role:"Product Technology, Summer Intern",description:"Developed Synchronous and Asynchronous APIs using AWS Lambda, API Gateway, S3, SNS, SES, State Machine, Event Bridge, AWS X-Ray, AWS Cognito, Cloud Formation, DynamoDB, and Java Spring Boot. Implemented end-to-end traceability and logic to catch and notify errors in a live environment.",location:"Pune, Maharashtra, India",skills:"Amazon Web Services (AWS), Spring Boot, Java",type:"Internship"},{duration:"Jan 2022 - May 2023",company:"CodeChef",role:"Educator",description:'I am working as an educator at CodeChef. My job in this role is to solve competitive programming problems and create video editorials to help beginners learn and understand basic math, data structures, and algorithms to develop problem-solving skills. I have helped thousands of participants by creating over 130+ video editorials for problems with difficulty up to "CodeChef Easy".',location:"India • Remote",skills:"Problem Solving, Communication, Teaching, Competitive Programming, Data Structures, Algorithms",type:"Part Time"},{duration:"Feb 2022 - Apr 2022",company:"CloudRocks pvt. ltd. (Cloudbloq)",role:"Software Engineer Intern",description:"During this internship, I worked with modern technologies like ReactJs & NodeJs. Majorly I had Enhanced User Authentication Flow and Implemented Analytic Viewer. I worked closely with senior developers and my mentor at CloudBloq to implement new features and fixed various bugs in the frontend and backend.",location:"India • Remote",skills:"Node.js, React.js, SCSS, React-Saga",type:"Internship"},{duration:"Jun 2021 - Dec 2021",company:"MythView",role:"Freelance Backend Engineer",description:"Implemented User Authentication System, Multi-Account (Personal & Community), Likes and infinitely nested comment on users post, News-Feed generation from followed accounts.",location:"India • Remote",skills:"Node.js, Express.js, Cloud Firestore, GraphQL, Cloud Storage, Stoplight Studio",type:"Freelance"}],W=r.section`
...
`,O=({duration:t,company:o,role:s,description:l,location:a,link:i,skills:C})=>e.jsxs(B,{children:[e.jsxs(F,{children:[e.jsx("span",{children:t}),e.jsx("span",{children:a})]}),e.jsxs(H,{children:[e.jsx(V,{children:o}),e.jsx(G,{children:s})]}),e.jsx(J,{children:l}),e.jsxs(N,{children:[e.jsx("b",{children:"Skills:"})," ",C," "]}),i&&e.jsx(U,{to:i,children:"Learn More"})]}),q=()=>e.jsxs(W,{children:[e.jsx($,{children:"Experience"}),e.jsx(D,{children:T.map(t=>e.jsx(O,{...t},t.company))})]}),Q=t=>n.createElement("svg",{width:48,height:48,viewBox:"0 0 48 48",fill:"none",xmlns:"http://www.w3.org/2000/svg",...t},n.createElement("path",{d:"M0 24C0 10.7452 10.7452 0 24 0C37.2548 0 48 10.7452 48 24C48 37.2548 37.2548 48 24 48C10.7452 48 0 37.2548 0 24Z",fill:"none"}),n.createElement("path",{d:"M21 31C16.7 32.4 16.7 28.5 15 28M27 33V29.5C27 28.5 27.1 28.1 26.5 27.5C29.3 27.2 32 26.1 32 21.5C31.9988 20.3049 31.5325 19.1573 30.7 18.3C31.0905 17.2619 31.0545 16.1116 30.6 15.1C30.6 15.1 29.5 14.8 27.1 16.4C25.0672 15.8705 22.9328 15.8705 20.9 16.4C18.5 14.8 17.4 15.1 17.4 15.1C16.9455 16.1116 16.9095 17.2619 17.3 18.3C16.4675 19.1573 16.0012 20.3049 16 21.5C16 26.1 18.7 27.2 21.5 27.5C20.9 28.1 20.9 28.7 21 29.5V33",stroke:"var(--background-primary_theme)",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round"})),X=t=>n.createElement("svg",{width:48,height:48,viewBox:"0 0 48 48",fill:"none",xmlns:"http://www.w3.org/2000/svg",...t},n.createElement("path",{d:"M0 24C0 10.7452 10.7452 0 24 0C37.2548 0 48 10.7452 48 24C48 37.2548 37.2548 48 24 48C10.7452 48 0 37.2548 0 24Z",fill:"none"}),n.createElement("path",{d:"M30 16H18C16.8954 16 16 16.8954 16 18V30C16 31.1046 16.8954 32 18 32H30C31.1046 32 32 31.1046 32 30V18C32 16.8954 31.1046 16 30 16Z",stroke:"var(--background-primary_theme)",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round"}),n.createElement("path",{d:"M20 23V28M20 20V20.01M24 28V23M28 28V25C28 24.4696 27.7893 23.9609 27.4142 23.5858C27.0391 23.2107 26.5304 23 26 23C25.4696 23 24.9609 23.2107 24.5858 23.5858C24.2107 23.9609 24 24.4696 24 25",stroke:"var(--background-primary_theme)",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round"})),Y=t=>n.createElement("svg",{width:48,height:48,viewBox:"0 0 48 48",fill:"none",xmlns:"http://www.w3.org/2000/svg",...t},n.createElement("path",{d:"M0 24C0 10.7452 10.7452 0 24 0C37.2548 0 48 10.7452 48 24C48 37.2548 37.2548 48 24 48C10.7452 48 0 37.2548 0 24Z",fill:"none"}),n.createElement("path",{d:"M31 17H17C15.8954 17 15 17.8954 15 19V29C15 30.1046 15.8954 31 17 31H31C32.1046 31 33 30.1046 33 29V19C33 17.8954 32.1046 17 31 17Z",stroke:"var(--background-primary_theme)",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round"}),n.createElement("path",{d:"M15 19L24 25L33 19",stroke:"var(--background-primary_theme)",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round"})),K=t=>n.createElement("svg",{width:48,height:48,viewBox:"0 0 48 48",fill:"none",xmlns:"http://www.w3.org/2000/svg",...t},n.createElement("path",{d:"M0 24C0 10.7452 10.7452 0 24 0C37.2548 0 48 10.7452 48 24C48 37.2548 37.2548 48 24 48C10.7452 48 0 37.2548 0 24Z",fill:"none"}),n.createElement("path",{d:"M34 16.01C33 16.5 32.02 16.699 31 17C29.879 15.735 28.217 15.665 26.62 16.263C25.023 16.861 23.977 18.323 24 20V21C20.755 21.083 17.865 19.605 16 17C16 17 11.818 24.433 20 28C18.128 29.247 16.261 30.088 14 30C17.308 31.803 20.913 32.423 24.034 31.517C27.614 30.477 30.556 27.794 31.685 23.775C32.0218 22.5527 32.189 21.2899 32.182 20.022C32.18 19.773 33.692 17.25 34 16.009V16.01Z",stroke:"var(--background-primary_theme)",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round"})),e1="/assets/profile2-cf92cbf3.jpg",t1=r.div`
...
`,n1=r.div`
    ...
    text-align: center;
    color: var(--color-primary_theme);
`,p=({title:t,data:o})=>e.jsxs(t1,{children:[e.jsx(n1,{children:o}),e.jsx(r1,{children:t})]}),m=[{platform:"LeetCode",problemsCount:d.leetcode.problemsCount,profileLink:d.leetcode.profileLink},{platform:"CodeChef",problemsCount:d.codechef.problemsCount,profileLink:d.codechef.profileLink},{platform:"GeeksForGeeks",problemsCount:d.gfg.problemsCount,profileLink:d.gfg.profileLink},{platform:"CodeForces",problemsCount:d.codeforces.problemsCount,profileLink:d.codeforces.profileLink},{platform:"InterviewBit",problemsCount:6,profileLink:d.interviewbit.profileLink+"/solved-problems"},{platform:"HackerEarth",problemsCount:8,profileLink:d.hackerearth.profileLink}],w=()=>{let t=0;return m.forEach(o=>t+=o.problemsCount),t-=t%10,t},o1=r.div`
    display: grid;
...
`,i1=()=>e.jsxs(o1,{children:[e.jsx(p,{title:"Internships",data:"3"}),e.jsx(p,{title:"DSA Problems Solved",data:`+${w()}`}),e.jsx(f,{to:"/projects",children:e.jsx(p,{title:"Projects",data:"+10"})}),e.jsx(p,{title:"Research Papers",data:"3"}),e.jsx(p,{title:"Certifications",data:"+16"}),e.jsx(p,{title:"Games Developed",data:"+2"})]}),a1=["Developer!","Designer!","Engineer!","Educator!","Student!"],s1=r.section`
    display: flex;
...
`,w1=({projects:t})=>{const s=t.length-1,l=a=>-20*a-s*-20/2;return e.jsx(v1,{children:t.map((a,i)=>e.jsx(j1,{top:l(i),children:e.jsx(S,{...a})},a.title))})},y1=r(f)`
    position: relative;
    top: -28px;
    display: block;
    width: 171.48px;
...
`,b1=()=>{const{width:t}=j(),o=t>1450?4:2,s=[],l=E.slice(0,4);for(let a=0;a<l.length/o;++a){s.push([]);for(let i=0;i<o;++i)s[a].push(l[a*o+i])}return e.jsxs("section",{children:[e.jsx(f1,{children:"Latest Projects"}),e.jsx(u1,{children:s.map(a=>e.jsx(w1,{projects:a},a[0].title))}),e.jsx(y1,{to:"projects",children:e.jsx(g1,{})})]})},k1=r.div`
    background-color: ${t=>t.background};
    height: ${t=>t.height};
    width: 100%;
    border-radius: calc(${t=>t.height} / 2);
    overflow: hidden;
`,L1=r.div`
    ...
    height: ${t=>t.height};
    border-radius: calc(${t=>t.height} / 2);
`,S1=({percent:t,color:o,background:s,height:l})=>(l||(l="100%"),e.jsx(k1,{background:s,height:l,children:e.jsx(L1,{color:o,percent:t,height:l})})),E1=r.section`
    background-color: var(--background-secondary_theme);
`,M1=r.div`
    padding: 72px 0;
    font-weight: 700;
...
`,R1=r.div`
    text-align: center;
    font-size: 20px;
`,T1=()=>{m.sort((i,C)=>C.problemsCount-i.problemsCount);const t=m[0].problemsCount*1.1,o=[],s=m.reduce((i,C)=>i+C.problemsCount,0);let l=0,a=0;for(let i=0;i<m.length;i++){const C=m[i];l<s*.8?o.push(C):a+=C.problemsCount,l+=C.problemsCount}return a>0&&o.push({platform:"Other Platforms",problemsCount:a}),e.jsxs(E1,{children:[e.jsx(M1,{children:"Problem Solving"}),e.jsxs(I1,{children:[e.jsxs(R1,{children:[e.jsxs("strong",{children:[w(),"+"]})," Quality Problems solved on Various Platforms"]}),o.map(i=>e.jsxs(Z1,{href:i.profileLink,rel:"noopener noreferrer",target:"_blank",children:[e.jsxs(z1,{children:[e.jsx(A1,{children:i.platform}),e.jsx(_1,{children:i.problemsCount})]}),e.jsx(S1,{color:"var(--border-primary_theme)",background:"var(--background-primary)",percent:i.problemsCount/t*100,height:"20px"})]},i.platform))]}),e.jsxs(P1,{children:[d.codechef.stars," on CodeChef"]})]})},W1=r.section`
    display: flex;
    flex-direction: column;
    padding: 72px 0;
    gap: 72px;
...
`,c=r.div`
    font-size: 16px;
`,F1=()=>e.jsxs(W1,{children:[e.jsx($1,{children:"Skills"}),e.jsx(D1,{children:"Data Structures and Algorithms, UI & UX, Web Development"}),e.jsxs(B1,{children:[e.jsxs(x,{children:[e.jsx(g,{children:"Programming Language"}),e.jsx(c,{children:"C / C++"}),e.jsx(c,{children:"TypeScript"}),e.jsx(c,{children:"JavaScript"}),e.jsx(c,{children:"Python"}),e.jsx(c,{children:"Java"}),e.jsx(c,{children:"Assembly"})]}),e.jsx(u,{}),e.jsxs(x,{children:[e.jsx(g,{children:"Cloud Technology"}),e.jsx(c,{children:"AWS Dynamodb"}),e.jsx(c,{children:"AWS Lambda"}),e.jsx(c,{children:"AWS App Sync"}),e.jsx(c,{children:"Google Firebase"}),e.jsx(c,{children:"Google FireStore"}),e.jsx(c,{children:"Google App Engine"})]}),e.jsx(u,{}),e.jsxs(x,{children:[e.jsx(g,{children:"Other Technologies"}),e.jsx(c,{children:"Git / GitHub"}),e.jsx(c,{children:"React.js / Next.js"}),e.jsx(c,{children:"Rest / GraphQL API"}),e.jsx(c,{children:"Figma / FigJam"}),e.jsx(c,{children:"Lit / Lit HTML"}),e.jsx(c,{children:"SCSS / CSS"})]})]})]}),H1=["I like Photography!","I like Travelling!","I like Music!"],V1=r.div`
    display: flex;
    padding: 100px 0;
    justify-content: center;
    align-content: center;
`,O1=()=>(n.useLayoutEffect(()=>{window.scrollTo({top:0,left:0,behavior:"instant"})},[]),e.jsxs(e.Fragment,{children:[e.jsx(x1,{}),e.jsx(V1,{children:e.jsx(v,{sentences:H1})}),e.jsx(q,{}),e.jsx(b1,{}),e.jsx(T1,{}),e.jsx(F1,{}),e.jsx(M,{})]}));export{O1 as default};
