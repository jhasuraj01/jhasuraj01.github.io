...
`,N=({duration:n,company:i,role:s,description:c,location:o,link:l,skills:p})=>e.jsxs(W,{children:[e.jsxs(D,{children:[e.jsx("span",{children:n}),e.jsx("span",{children:o})]}),e.jsxs(F,{children:[e.jsx(G,{children:i}),e.jsx(H,{children:s})]}),e.jsx(V,{children:c}),e.jsxs(J,{children:[e.jsx("b",{children:"Skills:"})," ",p," "]}),l&&e.jsx($,{to:l,children:"Learn More"})]}),U=()=>e.jsxs(T,{children:[e.jsx(_,{children:"Experience"}),e.jsx(B,{children:z.map(n=>e.jsx(N,{...n},n.company))})]}),O=n=>t.createElement("svg",{width:48,height:48,viewBox:"0 0 48 48",fill:"none",xmlns:"http://www.w3.org/2000/svg",...n},t.createElement("path",{d:"M0 24C0 10.7452 10.7452 0 24 0C37.2548 0 48 10.7452 48 24C48 37.2548 37.2548 48 24 48C10.7452 48 0 37.2548 0 24Z",fill:"none"}),t.createElement("path",{d:"M21 31C16.7 32.4 16.7 28.5 15 28M27 33V29.5C27 28.5 27.1 28.1 26.5 27.5C29.3 27.2 32 26.1 32 21.5C31.9988 20.3049 31.5325 19.1573 30.7 18.3C31.0905 17.2619 31.0545 16.1116 30.6 15.1C30.6 15.1 29.5 14.8 27.1 16.4C25.0672 15.8705 22.9328 15.8705 20.9 16.4C18.5 14.8 17.4 15.1 17.4 15.1C16.9455 16.1116 16.9095 17.2619 17.3 18.3C16.4675 19.1573 16.0012 20.3049 16 21.5C16 26.1 18.7 27.2 21.5 27.5C20.9 28.1 20.9 28.7 21 29.5V33",stroke:"var(--background-primary_theme)",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round"})),q=n=>t.createElement("svg",{width:48,height:48,viewBox:"0 0 48 48",fill:"none",xmlns:"http://www.w3.org/2000/svg",...n},t.createElement("path",{d:"M0 24C0 10.7452 10.7452 0 24 0C37.2548 0 48 10.7452 48 24C48 37.2548 37.2548 48 24 48C10.7452 48 0 37.2548 0 24Z",fill:"none"}),t.createElement("path",{d:"M30 16H18C16.8954 16 16 16.8954 16 18V30C16 31.1046 16.8954 32 18 32H30C31.1046 32 32 31.1046 32 30V18C32 16.8954 31.1046 16 30 16Z",stroke:"var(--background-primary_theme)",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round"}),t.createElement("path",{d:"M20 23V28M20 20V20.01M24 28V23M28 28V25C28 24.4696 27.7893 23.9609 27.4142 23.5858C27.0391 23.2107 26.5304 23 26 23C25.4696 23 24.9609 23.2107 24.5858 23.5858C24.2107 23.9609 24 24.4696 24 25",stroke:"var(--background-primary_theme)",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round"})),Q=n=>t.createElement("svg",{width:48,height:48,viewBox:"0 0 48 48",fill:"none",xmlns:"http://www.w3.org/2000/svg",...n},t.createElement("path",{d:"M0 24C0 10.7452 10.7452 0 24 0C37.2548 0 48 10.7452 48 24C48 37.2548 37.2548 48 24 48C10.7452 48 0 37.2548 0 24Z",fill:"none"}),t.createElement("path",{d:"M31 17H17C15.8954 17 15 17.8954 15 19V29C15 30.1046 15.8954 31 17 31H31C32.1046 31 33 30.1046 33 29V19C33 17.8954 32.1046 17 31 17Z",stroke:"var(--background-primary_theme)",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round"}),t.createElement("path",{d:"M15 19L24 25L33 19",stroke:"var(--background-primary_theme)",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round"})),X=n=>t.createElement("svg",{width:48,height:48,viewBox:"0 0 48 48",fill:"none",xmlns:"http://www.w3.org/2000/svg",...n},t.createElement("path",{d:"M0 24C0 10.7452 10.7452 0 24 0C37.2548 0 48 10.7452 48 24C48 37.2548 37.2548 48 24 48C10.7452 48 0 37.2548 0 24Z",fill:"none"}),t.createElement("path",{d:"M34 16.01C33 16.5 32.02 16.699 31 17C29.879 15.735 28.217 15.665 26.62 16.263C25.023 16.861 23.977 18.323 24 20V21C20.755 21.083 17.865 19.605 16 17C16 17 11.818 24.433 20 28C18.128 29.247 16.261 30.088 14 30C17.308 31.803 20.913 32.423 24.034 31.517C27.614 30.477 30.556 27.794 31.685 23.775C32.0218 22.5527 32.189 21.2899 32.182 20.022C32.18 19.773 33.692 17.25 34 16.009V16.01Z",stroke:"var(--background-primary_theme)",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round"})),K="/assets/profile-fdeda934.webp",Y=r.div`
...
`,t1=r.div`
    ...
    text-align: center;
    color: var(--color-primary_theme);
`,d=({title:n,data:i})=>e.jsxs(Y,{children:[e.jsx(t1,{children:i}),e.jsx(e1,{children:n})]}),n1={profileLink:"https://leetcode.jhasuraj.com",problemsCount:480,maxContestRating:2001.6592754053825},r1={profileLink:"https://geeksforgeeks.jhasuraj.com",problemsCount:73},i1={profileLink:"https://codechef.jhasuraj.com",maxRating:1938,problemsCount:275,stars:"4★"},o1={profileLink:"https://codeforces.jhasuraj.com",maxRating:1449,problemsCount:130,rank:"specialist"},a1={profileLink:"https://interviewbit.jhasuraj.com"},s1={profileLink:"https://hackerearth.jhasuraj.com"},C={leetcode:n1,gfg:r1,codechef:i1,codeforces:o1,interviewbit:a1,hackerearth:s1},l1=[{platform:"LeetCode",problemsCount:C.leetcode.problemsCount,profileLink:C.leetcode.profileLink},{platform:"CodeChef",problemsCount:C.codechef.problemsCount,profileLink:C.codechef.profileLink},{platform:"GeeksForGeeks",problemsCount:C.gfg.problemsCount,profileLink:C.gfg.profileLink},{platform:"CodeForces",problemsCount:C.codeforces.problemsCount,profileLink:C.codeforces.profileLink},{platform:"InterviewBit",problemsCount:6,profileLink:C.interviewbit.profileLink+"/solved-problems"},{platform:"HackerEarth",problemsCount:8,profileLink:C.hackerearth.profileLink}],c1=()=>{let n=0;return l1.forEach(i=>n+=i.problemsCount),n-=n%10,n},C1=r.div`
    display: grid;
...
`,d1=()=>e.jsxs(C1,{children:[e.jsx(d,{title:"Internships",data:"3"}),e.jsx(d,{title:"DSA Problems Solved",data:`+${c1()}`}),e.jsx(g,{to:"/projects",children:e.jsx(d,{title:"Projects",data:"+10"})}),e.jsx(d,{title:"Research Papers",data:"3"}),e.jsx(d,{title:"Certifications",data:"+16"}),e.jsx(d,{title:"Games Developed",data:"+2"})]}),p1=["Developer!","Designer!","Engineer!","Educator!","Student!"],h1=r.section`
    display: flex;
...
`,S1=r.div`
    ...
    max-width: 400px;
    @media (min-width: 744px) {
        transform: translateY(${n=>n.top}%);
    }
`,E1=({projects:n})=>{const s=n.length-1,c=o=>-20*o-s*-20/2;return e.jsx(b1,{children:n.map((o,l)=>e.jsx(S1,{top:c(l),children:e.jsx(L,{...o})},o.title))})},M1=r(g)`
    position: relative;
    top: -28px;
    display: block;
    width: 171.48px;
...
`,I1=()=>{const{width:n}=v(),i=n>1450?4:2,s=[],c=b.slice(0,4);for(let o=0;o<c.length/i;++o){s.push([]);for(let l=0;l<i;++l)s[o].push(c[o*i+l])}return e.jsxs("section",{children:[e.jsx(k1,{children:"Latest Projects"}),e.jsx(L1,{children:s.map(o=>e.jsx(E1,{projects:o},o[0].title))}),e.jsx(M1,{to:"projects",children:e.jsx(w1,{})})]})},A1=r.div`
    display: flex;
    flex-direction: column;
    padding: 72px 0;
    gap: 72px;
    ${({showThemeBg:n})=>n?"background-color: var(--background-secondary_theme);":""}
`,Z1=r.div`
    font-weight: 700;
    font-size: 64px;
    text-align: center;
...
`,a=r.div`
    font-size: 16px;
`,z1=({showThemeBg:n=!1})=>e.jsxs(A1,{showThemeBg:n,children:[e.jsx(Z1,{children:"Skills"}),e.jsx(P1,{children:"Data Structures and Algorithms, UI & UX, Web Development"}),e.jsxs(R1,{children:[e.jsxs(m,{children:[e.jsx(x,{children:"Programming Language"}),e.jsx(a,{children:"C / C++"}),e.jsx(a,{children:"TypeScript"}),e.jsx(a,{children:"JavaScript"}),e.jsx(a,{children:"Python"}),e.jsx(a,{children:"Java"}),e.jsx(a,{children:"Assembly"})]}),e.jsx(f,{}),e.jsxs(m,{children:[e.jsx(x,{children:"Cloud Technology"}),e.jsx(a,{children:"AWS Dynamodb"}),e.jsx(a,{children:"AWS Lambda"}),e.jsx(a,{children:"AWS App Sync"}),e.jsx(a,{children:"Google Firebase"}),e.jsx(a,{children:"Google FireStore"}),e.jsx(a,{children:"Google App Engine"})]}),e.jsx(f,{}),e.jsxs(m,{children:[e.jsx(x,{children:"Other Technologies"}),e.jsx(a,{children:"Git / GitHub"}),e.jsx(a,{children:"React.js / Next.js"}),e.jsx(a,{children:"Rest / GraphQL API"}),e.jsx(a,{children:"Figma / FigJam"}),e.jsx(a,{children:"Lit / Lit HTML"}),e.jsx(a,{children:"SCSS / CSS"})]})]})]}),T1=["I like Photography!","I like Travelling!","I like Music!"],_1=r.div`
    display: flex;
    padding: 100px 0;
    justify-content: center;
    align-content: center;
`,D1=()=>(t.useLayoutEffect(()=>{window.scrollTo({top:0,left:0,behavior:"instant"})},[]),e.jsxs(e.Fragment,{children:[e.jsx(y1,{}),e.jsx(_1,{children:e.jsx(u,{sentences:T1})}),e.jsx(U,{}),e.jsx(I1,{}),e.jsx(z1,{showThemeBg:!0}),e.jsx(S,{})]}));export{D1 as default};
