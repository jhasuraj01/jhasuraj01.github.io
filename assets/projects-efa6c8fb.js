import{r,j as e,s as i}from"./main-2b3205f0.js";const h="_text_uwn3w_1",d={text:h,"roll-up":"_roll-up_uwn3w_1"},R=({sentences:t})=>{const[n,a]=r.useState(t[0]);return r.useEffect(()=>{let o=0;const l=setInterval(()=>{o=(o+1)%t.length,a(t[o])},1500);return()=>clearInterval(l)},[t]),e.jsx("div",{className:d.text,children:n},n)},u=i.a`
    display: flex;
    flex-grow: 1;
    align-items: center;
    padding: 12px;
